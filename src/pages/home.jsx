      ...
      <div className="col-lg-9">
        ...
        <nav className="navbar navbar-expand-lg bg-white navbar-light p-0">
          ...
          >
            ...
            <a href="chat" className="btn btn-primary mr-3 d-none d-lg-block">
              Get A Quote
            </a>
      ...
      <div className="row">
        ...
        <div className="col-lg-9 pt-5 pt-lg-0">
          ...
          >
            ...
            <div className="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
              <div className="icon-box bg-secondary text-primary mt-2 mb-4">
                <i className="fa fa-2x fa-hand-holding-usd" />
              </div>
        ...
        <div className="col-12">
          ...
          >
            ...
            <div className="team-item text-center bg-white rounded overflow-hidden pt-4">
              ...
              <p className="mb-3 px-4">Practice Area</p>
              <div className="team-img position-relative">
                <img className="img-fluid" src="public/img/team-2.jpg" alt="" />
                <div className="team-social">
                  <a className="btn btn-outline-light btn-square mx-1" href="#">
                    <i className="fab fa-twitter" />
                  </a>
            ...
            <div className="team-item text-center bg-white rounded overflow-hidden pt-4">
              ...
              <p className="mb-3 px-4">Practice Area</p>
              <div className="team-img position-relative">
                <img className="img-fluid" src="public/img/team-4.jpg" alt="" />
                <div className="team-social">
                  <a className="btn btn-outline-light btn-square mx-1" href="#">
                    <i className="fab fa-twitter" />
                  </a>
      ...
      <div className="owl-carousel testimonial-carousel">
        ...
        <div className="testimonial-item">
          ...
          <div className="d-flex align-items-center pt-3">
            <img
              className="img-fluid rounded-circle"
              src="public/img/testimonial-2.jpg"
              style={{ width: 80, height: 80 }}
              alt=""
            />
            <div className="pl-4">
        ...
        <div className="testimonial-item">
          ...
          <div className="d-flex align-items-center pt-3">
            <img
              // className="img-fluid rounded-circle"
              src="public/img/testimonial-3.jpg"
              style={{ width: 80, height: 80 }}
              alt=""
            />
            <div className="pl-4">
        ...
        <div className="testimonial-item">
          ...
          <div className="d-flex align-items-center pt-3">
            <img
              className="img-fluid rounded-circle"
              src="public/img/testimonial-4.jpg"
              style={{ width: 80, height: 80 }}
              alt=""
            />
            <div className="pl-4">
